...
export const DateRangeSelector: React.FC<Props> = ({
  ...
  return (
  <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-700 shadow p-6 mb-8">
      <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Filter by Date Range</h2>
      
      {/* Quick Range Buttons */}
      <div className="mb-6">
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Quick Ranges</h3>
            ...
            <button
              ...
              className={`px-3 py-1 text-sm border transition-colors ${
                startMonth === range.start && endMonth === range.end
                  ...
                  : 'bg-white dark:bg-black text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800'
              }`}
            >
              {range.label}
            </button>
      ...
      {/* Year Range Buttons */}
      <div className="mb-6">
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">By Year</h3>
        <div className="flex flex-wrap gap-2">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="start-month" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            Start Month
          </label>
          <select
            id="start-month"
            ...
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 bg-white dark:bg-black text-gray-900 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          >
        ...
        <div>
          <label htmlFor="end-month" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            End Month
          </label>
          <select
            id="end-month"
